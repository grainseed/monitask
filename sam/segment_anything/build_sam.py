...
from .modeling import ImageEncoderViT, MaskDecoder,MaskDecoderHQ, PromptEncoder, Sam, TwoWayTransformer, TinyViT
...
def build_sam_vit_t(checkpoint=None,device="cpu"):
...
def build_mobile_sam(checkpoint=None,device="cpu"):
    prompt_embed_dim = 256
    image_size = 1024
    vit_patch_size = 16
    image_embedding_size = image_size // vit_patch_size
    ...
    if checkpoint is not None:
        ...
        mobile_sam.load_state_dict(state_dict,strict=True)
    return mobile_sam
