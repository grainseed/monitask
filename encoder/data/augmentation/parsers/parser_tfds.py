...
try:
    ...
    try:
        ...
        print_log("Warning: This version of tfds doesn't have the latest even_splits impl. "
              "Please update or use tfds-nightly for better fine-grained split behaviour.")
        has_buggy_even_splits = True
except ImportError as e:
    print_log(e)
    print_log("Please install tensorflow_datasets package `pip install tensorflow-datasets`.")
    exit(1)
